...
const TwallieCard = styled.div`
	...
	@media ${screens.laptop} {
		...
		left: 0;
		height: 110%;
		box-shadow: 0 10px 25px -5px rgba(0, 0, 0, 0.5), 0 10px 10px -5px rgba(0, 0, 0, 0.1);
	}
`
...
const WindowsLogo = styled(Windows)`
	width: 40px;
	height: 40px;
	fill: ${props => (props.accent ? props.accent : colors.secondaryBlack)} !important;
`
			...
			<Layout>
				...
				>
					<OrganicContainer ref={this.mainRef}>
						<OrganicText>
							<StyledCoffee />
							<AboveHeader>{intl.formatMessage({ id: "dev.templates" })}</AboveHeader>
							<Header>
						...
						<OtherStuff>
							<OtherHeader>{intl.formatMessage({ id: "dev.otherStuff" })}</OtherHeader>
							<OtherSubHeader>
					...
					<TwallieSecondContainer>
						...
						<TwallieCard>
							<UpperCard>
								...
								<CardDivider />
								<CardDescription>{intl.formatMessage({ id: "dev.twallieDesc" })}</CardDescription>
								<CardTechs>
				...
				<ArtistHuntContainer>
					...
					<AHBody>
						<AHBodyTitle>{intl.formatMessage({ id: "dev.ahTitle2" })}</AHBodyTitle>
						<AHBodyDescription>{intl.formatMessage({ id: "dev.ahDesc" })}</AHBodyDescription>
					</AHBody>
					<AvailableOn>
						<AvailableText>
				...
				<MindFulnessContainer>
					...
					<MindFulnessTextContainer>
						...
						<MFHeader>
							...
							<MFDescription>{intl.formatMessage({ id: "dev.mfDesc" })}</MFDescription>
						</MFHeader>
						<MFBody>
							<MFBodyTitle>{intl.formatMessage({ id: "dev.mfTitle2" })}</MFBodyTitle>
							<MFBodyDescription>{intl.formatMessage({ id: "dev.mfDesc2" })}</MFBodyDescription>
						</MFBody>
						<AvailableOn>
							<AvailableText>
								{intl.formatMessage({ id: "dev.available" })}
				...
				<GhenterpriseContainer>
					<GhenterpriseInnerContainer>
						<GPHeader>
							...
							<GPDescription>{intl.formatMessage({ id: "dev.gPDesc" })}</GPDescription>
						</GPHeader>
						<AvailableOn>
					...
					<MoroccoInnerContainer>
						...
						<MorrocoCard>
							<UpperCard>
								...
								<CardDivider />
								<CardDescription>{intl.formatMessage({ id: "dev.mor" })}</CardDescription>
								<CardTechs>
