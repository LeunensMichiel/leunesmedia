...
class filmmaking extends PureComponent {
	state = {
		type: "aftermovie",
		checked: true,
		selectedVideo: 0,
	...
	render() {
		...
		return (
			<Layout>
				<SEO title={intl.formatMessage({ id: "SEO.filmTitle" })} description={intl.formatMessage({ id: "SEO.filmDesc" })} />
				<FilmmakingContainer isDark={checked}>
					<Menu>
						<MenuItem
							...
							isDark={checked}
						>
							{intl.formatMessage({ id: "filmmaking.aftermovie" })}
						</MenuItem>
						<MenuItem
							...
							isDark={checked}
						>
							{intl.formatMessage({ id: "filmmaking.event" })}
						</MenuItem>
						<MenuItem
							...
							isDark={checked}
						>
							{intl.formatMessage({ id: "filmmaking.other" })}
						</MenuItem>
						<StyledSwitch>
							<Switch
								lastLeft={true}
...
export default injectIntl(filmmaking)
