		...
		return (
			<Layout>
				<SEO
					...
					description={intl.formatMessage({ id: "SEO.contactDesc" })}
				/>

				<ContactContainer>
					<ContactCard>
						<CardHeader>{intl.formatMessage({ id: "contact.title" })}</CardHeader>
						<IntlContextConsumer>
								...
								>
									...
									<FirstColumn>
										<InputContainer>
											...
											<StyledInput
												type='text'
												placeholder={intl.formatMessage({ id: "contact.placeholder1" })}
												id='firstName'
												name='firstName'
												required
											/>
										...
										<InputContainer>
											...
											<StyledInput
												type='text'
												placeholder={intl.formatMessage({ id: "contact.placeholder2" })}
												id='lastName'
												name='lastName'
												required
											/>
										...
										<InputContainer>
											...
											<StyledInput
												type='email'
												placeholder={intl.formatMessage({ id: "contact.placeholder3" })}
												id='email'
												name='email'
												required
											/>
										...
										<InputContainer>
											...
											<StyledInput
												type='tel'
												placeholder={intl.formatMessage({ id: "contact.placeholder4" })}
												id='phone'
												name='phone'
											/>
											<div className='bar' />
										...
										<InputContainer>
											...
											<StyledInput
												type='text'
												placeholder={intl.formatMessage({ id: "contact.placeholder5" })}
												id='subject'
												name='subject'
												required
											/>
									...
									<SecondColumn>
										<InputContainer className='textareaContainer'>
											...
											<StyledTextbox
												required
												placeholder={intl.formatMessage({ id: "contact.placeholder6" })}
												id='message'
												name='message'
											/>
											<div className='bar' />
											<Annotation>{intl.formatMessage({ id: "contact.footnote" })}</Annotation>
										</InputContainer>
										<StyledButton type='submit'>
											{intl.formatMessage({ id: "contact.sentBtn" })}
										</StyledButton>
									</SecondColumn>
								</Form>
							)}
					...
					<Information>
						...
						<InformationBlock>
							<InformationTitle>{intl.formatMessage({ id: "contact.address" })} 1</InformationTitle>
							<InformationContent>Herdebeekstraat 334</InformationContent>
							<InformationContent>1701 Itterbeek</InformationContent>
							<InformationContent>
								{intl.formatMessage({ id: "contact.belgium" })}
							</InformationContent>
						</InformationBlock>
						<InformationBlock>
							<InformationTitle>{intl.formatMessage({ id: "contact.address" })} 2</InformationTitle>
							<InformationContent>Kattenberg 71</InformationContent>
							<InformationContent>
								9000 {intl.formatMessage({ id: "contact.ghent" })}
							</InformationContent>
							<InformationContent>
								{intl.formatMessage({ id: "contact.belgium" })}
							</InformationContent>
				...
				>
					...
					<Marker longitude={3.724524} latitude={51.040051} offsetLeft={-20} offsetTop={-10}>
						<Pin />
					</Marker>
					<Marker longitude={4.235968} latitude={50.821324} offsetLeft={-20} offsetTop={-10}>
						<Pin />
					</Marker>
				</MapGL>
			</Layout>
